                            ...
                            <table className="w-full">
                                <thead className="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">People</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {gatePasses.map((pass) => (
                                        <tr key={pass.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-900">{pass.vehicle_number || "-"}</td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-900">{new Date(pass.valid_until).toLocaleDateString()}</td>
                                            <td className="px-6 py-4">
                                                {pass.used ? (
                                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Used</span>
                                                ) : (
                                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Active</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-4 text-sm text-gray-500">{new Date(pass.created_at).toLocaleDateString()}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
